...
async def get_organizations(building_id: int, db: db_dependency):
...
async def get_organizations_by_activity_route(activity_id: int, db: db_dependency):
...
async def get_organization_by_id_route(organization_id: int, db: db_dependency):
...
async def search_organizations_by_name_route(name: str, db: db_dependency):
...
async def search_organizations_by_activity_route(activity_name: str, db: db_dependency):
